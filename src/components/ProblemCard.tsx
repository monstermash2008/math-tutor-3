...
import { getDifficultyLevel } from '../lib/problem-library';
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm hover:shadow-md transition-all duration-200 group-hover:border-blue-300 h-full">
        ...
        <div className="flex items-start justify-between mb-4">
          <div className="flex gap-2 flex-wrap">
            ...
            <span className={`px-2 py-1 rounded-full text-xs font-medium border ${typeColors[problem.problemType]}`}>
        ...
        <div className="flex items-center justify-between text-sm text-gray-600">
          <span className="flex items-center">
            <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-label="Start problem">
