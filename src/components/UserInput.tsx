...
export function UserInput({ onCheckStep, isSolved, stepNumber }: UserInputProps) {
  ...
  return (
    <div className="mt-4">
      <label htmlFor="student-answer" className="block text-sm font-medium text-gray-700 mb-2">
